...
namespace Elite
{
	...
	public:
		...
		float GetMaxPropagationSteps() const { return m_MaxPropagationSteps / 50.f; };
		void SetMaxPropagationSteps(float maxPropagationSteps) { m_MaxPropagationSteps = int(maxPropagationSteps * 50.f); };
